...
export default async function page() {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-14 h-full">
      <FloatCard title={`${currentOccupant.nama} - ${currentOccupant.Kelas.nama}`} className="pt-5" floatClassName="top-[-1rem]">
        <h1 className="text-3xl font-bold px-10">Pasangan Calon Ketua & Wakil Ketua Osis</h1>
      </FloatCard>
